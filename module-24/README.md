...
***************************************************************************************************
## <a id="section-04"></a> **4 - Amazon EFS vs Amazon FSx for Windows vs Amazon FSx for Lustre**
...
***************************************************************************************************
## <a id="section-05"></a> **5 - Amazon Kinesis Data Streams vs Data Firehose vs Data Analytics vs Video Streams**
...
***************************************************************************************************
## <a id="section-06"></a> **6 - Amazon RDS vs DynamoDB**
...
***************************************************************************************************
## <a id="section-07"></a> **7 - Amazon S3 vs EBS vs EFS**
...
***************************************************************************************************
## <a id="section-08"></a> **8 - Amazon S3 vs Glacier**
...
***************************************************************************************************
## <a id="section-09"></a> **9 - Amazon SWF vs AWS Step Function vs Amazon SQS**
...
***************************************************************************************************
## <a id="section-10"></a> **10 - Application Load Balancer vs Network Load Balancer vs Classic Load Balancer**
...
***************************************************************************************************
## <a id="section-11"></a> **11 - AWS CloudTrail vs Amazon CloudWatch**
...
***************************************************************************************************
## <a id="section-12"></a> **12 - AWS DataSync vs Storage Gateway**
...
***************************************************************************************************
## <a id="section-13"></a> **13 - AWS Global Accelerator vs Amazon CloudFront**
...
***************************************************************************************************
## <a id="section-14"></a> **14 - AWS Secrets Manager vs Systems Manager Parameter Store**
...
***************************************************************************************************
## <a id="section-15"></a> **15 - Backup and Restore vs Pilot Light vs Warm Standby vs Multi – site**
...
***************************************************************************************************
## <a id="section-16"></a> **16 - CloudWatch Agent vs SSM Agent vs Custom Daemon Scripts**
...
***************************************************************************************************
## <a id="section-17"></a> **17 - EBS-SSD vs HDD**
...
***************************************************************************************************
## <a id="section-19"></a> **19 - EC2 Instance Health Check vs ELB Health Check vs Auto Scaling and Custom Health Check**
...
***************************************************************************************************
## <a id="section-20"></a> **20 - Elastic Beanstalk vs CloudFormation vs OpsWorks vs CodeDeploy**
...
***************************************************************************************************
## <a id="section-21"></a> **21 - ELB Health Checks vs Route 53 Health Checks For Target Health Monitoring**
...
***************************************************************************************************
## <a id="section-22"></a> **22 - Global Secondary Index vs Local Secondary Index**
...
***************************************************************************************************
## <a id="section-23"></a> **23 - Interface Endpoint vs Gateway Endpoint vs Gateway Load Balancer Endpoint**
...
***************************************************************************************************
## <a id="section-24"></a> **24 - Latency Routing vs Geoproximity Routing vs Geolocation Routing**
...
***************************************************************************************************
## <a id="section-25"></a> **25 - Redis Append – Only files vs Redis Replication**
...
***************************************************************************************************
## <a id="section-26"></a> **26 - Redis Cluster Mode Enabled vs Disabled vs Memcached**
...
***************************************************************************************************
## <a id="section-27"></a> **27 - S3 Pre-Signed URLS vs CloudFront Signed URLS vs Origin Access Identity**
...
***************************************************************************************************
## <a id="section-28"></a> **28 - S3 Standard vs S3 Standard-IA vs S3OneZone-IA**
...
***************************************************************************************************
## <a id="section-29"></a> **29 - S3 Transfer Acceleration vs Direct Connect vs VPN vs Snowball vs Snowmobile**
...
***************************************************************************************************
## <a id="section-32"></a> **32 - SNI Custom SSL vs Dedicated IP Custom SSL**
...
***************************************************************************************************
## <a id="section-33"></a> **33 - Step Scaling vs Simple Scaling Policies in Amazon EC2**
